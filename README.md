...
- An RDBMS is a Relational Database Management System. It is the database software itself, which manages storage, querying, updating, and everything else. SQL is the Structured Query Language which is a language which is typically used to query the RDBMS.
